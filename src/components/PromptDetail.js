...
function buildBasicHeader(form) {
  ...
  const lines = ['0. 사용자 입력 (여기 채워서 사용)', ''];
  ...
  return (
    <main className="app-shell detail-page">
      ...
      {prompt.category === 'tarot' ? (
          ...
          {tarotType === 'wealth' ? (
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">돈 상황</span>
                <textarea
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">재정 상태</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">수입 형태</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">주요 고민</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">선택 상황</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">단기/장기</span>
                <select
            ...
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">현재 고민</span>
                <textarea
                  className="detail-input detail-textarea"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">현재 상태</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">나이/시기</span>
                <input
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">궁금한 것</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">특정 인물</span>
            ...
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">현재 상황</span>
                <textarea
                  className="detail-input detail-textarea"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">상태</span>
            ...
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">상황 분야</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">관련 인물</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">궁금한 포인트</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
        ...
        <section className="detail-form" aria-label="풍수지리 입력 정보">
          {isMovingFengshui ? (
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">현재 상태</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">집 유형</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">위치 정보</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">집 구조</span>
                <textarea
                  className="detail-input detail-textarea"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">고민</span>
                <textarea
                  className="detail-input detail-textarea"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">중요 기준</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
            ...
            <>
              <div className="detail-form-row">
                <span className="detail-form-label">도시</span>
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">집 방향</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">집 형태</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">침실 방향</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">작업공간</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
              ...
              <div className="detail-form-row">
                <span className="detail-form-label">머무는 위치</span>
                <input
                  className="detail-input detail-input-long"
                  type="text"
        ...
        <section className="detail-form" aria-label="관상/손금 안내">
          <p className="detail-guide">{physiognomyGuide}</p>
        </section>
      ) : (
        <section className="detail-form" aria-label="기본 입력 정보">
          ...
          <div className="detail-form-row">
            <span className="detail-form-label">태어난 시간</span>
            ...
            <span className="detail-unit">시</span>
            ...
            <span className="detail-unit">분</span>
          </div>

          <div className="detail-form-row">
            <span className="detail-form-label">태어난 장소</span>
            <input className="detail-input detail-input-place" type="text" value={form.birthCountry} onChange={handleInputChange('birthCountry')} placeholder="국가" />
            <input className="detail-input detail-input-place" type="text" value={form.birthCity} onChange={handleInputChange('birthCity')} placeholder="지역" />
          </div>

          <div className="detail-form-row">
            <span className="detail-form-label">성별</span>
            <label className="detail-radio">
          ...
          <div className="detail-form-row">
            <span className="detail-form-label">궁금한 점</span>
